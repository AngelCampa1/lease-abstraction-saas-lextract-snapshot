...
**Companion skill:** `ai-seo` covers RAG mechanics, semantic chunk engineering, platform-specific biases (ChatGPT vs Gemini vs Codex), and the 7 core ranking determinants. This skill covers everything else.
...
```markdown
# Lextract
> AI-powered lease abstraction platform that extracts 126 structured fields from commercial leases.

## Core Product
- [How It Works](/docs/how-it-works.md): Upload lease PDF, get structured extraction report
- [Pricing](/docs/pricing.md): $15/lease, 5-pack $65, 10-pack $120

## Resources
- [Lease Abstraction Guide](/docs/lease-abstraction-guide.md): Complete guide to commercial lease abstraction
- [Glossary](/docs/glossary.md): NNN, pro-rata share, gross-up, CAM, base year definitions
```
